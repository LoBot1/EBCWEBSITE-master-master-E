    ...
    return <div className="rsrv-info-contain">
        ...
        <form>
            <div className="info-resadd">
                ...
                <img src={require(`${process.cwd()}/src/image/pictures/`+ props.reservation.mainImage)}></img>
                }
                </div>
                ...
                <img src={require(`${process.cwd()}/src/image/pictures/`+ props.reservation.image1)}></img>
                }
                </div>
                ...
                <img src={require(`${process.cwd()}/src/image/pictures/` + props.reservation.image2)}></img>
                }
                </div>
                ...
                <img src={require(`${process.cwd()}/src/image/pictures/`+ props.reservation.image3)}></img>
                }
                </div>
                ...
                <img src={require(`${process.cwd()}/src/image/pictures/` + props.reservation.video)}></img>
                }
                </div>
