...
export function ReservationInfo(props) {
    ...
    {    
        setPathMainImage ((require(`${process.cwd()}/src/image/pictures/` + info.resa.mainImage)))
    }
    if (info.resa.image1.length > 0)
    {    
        setPathImage1 ((require(`${process.cwd()}/src/image/pictures/` + info.resa.image1)))
    }
    if (info.resa.image2.length > 0)
    {    
        setPathImage2 ((require(`${process.cwd()}/src/image/pictures/` + info.resa.image2)))
    }
    if (info.resa.image3.length > 0)
    {    
        setPathImage3 ((require(`${process.cwd()}/src/image/pictures/` + info.resa.image3)))
    }
    if (info.resa.video.length > 0)
    {    
        setPathVideo ((require(`${process.cwd()}/src/image/pictures/` + info.resa.video)))
    }
